...
document.getElementById('form').addEventListener("submit", async (e) => {
    ...
    if (searchTerm) {
        ...
        window.location.href = `results.html?movieName=${searchTerm}`;
...
let selected_text = document.querySelector(".filter")
let filterSearch = document.querySelector(".filterSearch")
let choices = document.querySelectorAll(".filterSearch")
